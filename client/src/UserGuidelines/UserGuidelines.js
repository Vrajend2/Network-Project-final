  ...
  return (
    <div className="user-manual">
      ...
      <p>
        ...
        <br />
        The Personal Budget Management App allows you to manage
        your budget efficiently by allocating the amount to different categories and tracking
        your expenses.
      </p>
      ...
      <p>
        ...
        <br />
        For new user, click on the "Register" button on the login page.
